package net.spartanb312.hyperlethal.utils;
...
public class ChatUtil {
    ...
    public static void sendNoSpamMessage(String message, int messageID){
        sendNoSpamRawChatMessage(SECTIONSIGN + "7[" + SECTIONSIGN + "9" + "HyperLethal" + SECTIONSIGN +"7] " + SECTIONSIGN + "r" + message, messageID);
    }
    public static void sendNoSpamMessage(String message){
        sendNoSpamRawChatMessage(SECTIONSIGN + "7[" + SECTIONSIGN + "9" + "HyperLethal" + SECTIONSIGN +"7] " + SECTIONSIGN + "r" + message);
    }
    ...
    public static void printChatMessage(String message) {
        printRawChatMessage(SECTIONSIGN + "7[" + SECTIONSIGN + "9" + "HyperLethal" + SECTIONSIGN +"7] " + SECTIONSIGN + "r" + message);
    }
    ...
    public static void sendSpamlessMessage (String message) {
        if (Utils.nullCheck()) return;
        final GuiNewChat chat = net.spartanb312.hyperlethal.utils.Wrapper.mc.ingameGUI.getChatGUI();
    ...
    private static void ChatMessage(String message){
        net.spartanb312.hyperlethal.utils.Wrapper.mc.ingameGUI.getChatGUI().printChatMessage(new TextComponentString(message));
    }
}
